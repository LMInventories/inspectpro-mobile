...
const HELP_CONTENT: Record<string, { cmd: string; note: string }[]> = {
  ...
  return: [
    { cmd: 'Return to Door and Frame, amend description, white painted panel door with brass handle',
      note: 'By Room: say "Return to [item name], amend description" to overwrite that field. Use "amend condition" for condition, or "amend" alone to replace both fields.' },
    { cmd: 'Return to Walls, add to condition, light scuffing to base throughout',
      note: '"Add to [field]" appends to what\'s already there rather than replacing it. "Add" alone appends to both fields.' },
    { cmd: 'Amend … / Add …',
    ...
    { cmd: 'Amend description … / Amend condition …',
      note: 'To target one field specifically, say "amend description", "amend condition", "add to description", or "add to condition" before the new content.' },
  ],
  tips: [
